...
const CardList = ({data}) => {
  ...
  return (
    <div className="cf pa2">
      ...
      <Button
          text="Previous" handleClick={() => handlePageChange(-limit)} disabled={offset === 0}
        />
        <Button
          text="Next" handleClick={() => handlePageChange(limit)} disabled={offset + limit >= filteredData.length}
        />
      </div>
    </div>
  )
